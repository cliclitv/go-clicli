...
export default function Pay() {
    ...
    useEffect(() => {
        pay({
            ...
            q.current.innerHTML = render(getMatrix(res.alipay_trade_precreate_response.qr_code), '#f77649')
    ...
    return <div className="vip">
        ...
        <h3>方式一：跳转支付宝APP</h3>
        <a href="" ref={q2}><button style={{ background: 'var(--theme)', margin: '20px' }}>点此充值</button></a>
        <h3>方式二：支付宝扫码</h3>
